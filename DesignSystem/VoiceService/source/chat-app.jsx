...
function RecQApp() {
  ...
  const voiceStyle = t.voiceStyle || 'immersive';
  ...
  return (
    <div style={{
      ...
      <main style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', position: 'relative' }}>
        ...
        <div style={{ borderTop: `1px solid ${LAV.hairlineSoft}`, padding: '0 32px 22px' }}>
          <div style={{ maxWidth: 760, margin: '0 auto' }}>
            {voice && voiceStyle === 'inline' ? (
              <div style={{ marginTop: 18 }}>
                <VoiceInline accent={accent} onCancel={() => setVoice(false)} onCommit={commitVoice}/>
              </div>
            ) : (
            <React.Fragment>
            ...
            <div style={{
              ...
              />
              <button type="button" aria-label="Voice" onClick={() => setVoice(true)} style={{
        ...
        {/* immersive voice overlay covers the conversation column */}
        {voice && voiceStyle === 'immersive' ? (
          <VoiceImmersive accent={accent} onCancel={() => setVoice(false)} onCommit={commitVoice}/>
        ) : null}
      </main>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSection label="Voice input"/>
        <TweakRadio label="Style" value={voiceStyle}
          options={['immersive', 'inline']}
          onChange={(v) => setTweak('voiceStyle', v)}/>
        <TweakButton label={voice ? 'Stop voice demo' : 'Play voice demo'} onClick={() => setVoice(v => !v)}/>
