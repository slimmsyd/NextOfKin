...
**Source of truth for product decisions:** `PlatformDocuments/Extra_Kin_Design_Context.docx`. When this file and the design doc disagree, the design doc wins — update AGENTS.md to match.
...
| Agent runtime | Codex API with structured outputs and tool use — *to be added* |
...
Defined in detail in the design doc, summarized here so Codex does not invent shapes:
