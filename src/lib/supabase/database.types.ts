// STUB: replace with output of `pnpm supabase gen types typescript --linked --schema public`.
// Real types are blocked on: (a) Supabase CLI logged into the account that owns the dev project,
